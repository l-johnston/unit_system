...
from unyt import unyt_quantity, define_unit
...
predefined_units["nH"] = Quantity(1e-9, "nH")
predefined_units["µH"] = Quantity(1e-6, "µH")
predefined_units["mH"] = Quantity(1e-3, "mH")
